  ...
  en: {
    pwa: {
      ...
      actionPlan: {
        ...
        subtitle: 'Follow these steps to install the app on your device',
        close: 'Maybe Later',
        gotIt: 'Got It!',
      },
      benefits: {
        native: {
          ...
          desc: 'Works like a native app with app icon and full-screen mode'
        },
        offline: {
        ...
        fast: {
          ...
          desc: 'Instant loading with cached resources'
        }
      },
      ios: {
        ...
        step1: {
          ...
          desc: 'Make sure you\'re using Safari browser'
        },
        step2: {
          title: 'Tap Share Button',
          desc: 'Look for the share icon in Safari toolbar'
        },
        step3: {
      ...
      android: {
        ...
        step1: {
          ...
          desc: 'Use Chrome or another compatible browser'
        },
        step2: {
          title: 'Browser Menu',
          desc: 'Tap the three dots menu in Chrome'
        },
        step3: {
          title: 'Install App',
          desc: 'Confirm installation when prompted'
        },
        step4: {
          title: 'Launch App',
      ...
      desktop: {
        ...
        step1: {
          ...
          desc: 'Use Chrome, Edge, or another PWA-compatible browser'
        },
        step2: {
          title: 'Install Prompt',
          desc: 'Click the install icon or use browser menu'
        },
        step3: {
          title: 'Desktop App',
          desc: 'App will open in its own window'
        }
      },
      notifications: {
        newThought: 'New thought captured',
        commitmentCreated: 'New commitment created',
        commitmentCompleted: 'Commitment completed!',
        reminderTitle: 'Don\'t forget!',
        dailyReminder: 'Time to review your commitments',
      },
    },
  },
  ar: {
    pwa: {
      ...
      installPrompt: {
        title: 'تثبيت التطبيق',
        description: 'احصل على التجربة الكاملة بتثبيت تطبيقنا على جهازك.',
        ...
        benefits: {
          ...
          homeScreen: 'وصول سريع من الشاشة الرئيسية',
          performance: 'أداء أفضل',
        },
      },
      actionPlan: {
        title: 'تثبيت التطبيق - خطة العمل',
        subtitle: 'اتبع هذه الخطوات لتثبيت التطبيق على جهازك',
        close: 'ربما لاحقاً',
        gotIt: 'فهمت!',
      },
      benefits: {
        native: {
          title: 'تجربة أصلية',
          desc: 'يعمل مثل التطبيق الأصلي مع أيقونة التطبيق ووضع الشاشة الكاملة'
        },
        offline: {
          title: 'الوصول بدون إنترنت',
          desc: 'استمر في العمل حتى بدون اتصال بالإنترنت'
        },
        fast: {
          title: 'تحميل أسرع',
          desc: 'تحميل فوري مع الموارد المخزنة مؤقتاً'
        }
      },
      ios: {
        ...
        step1: {
          ...
          desc: 'تأكد من أنك تستخدم متصفح Safari'
        },
        step2: {
          title: 'اضغط على زر المشاركة',
          desc: 'ابحث عن أيقونة المشاركة في شريط أدوات Safari'
        },
        step3: {
          title: 'أضف إلى الشاشة الرئيسية',
          desc: 'مرر لأسفل واضغط على "أضف إلى الشاشة الرئيسية"'
        },
        step4: {
          title: 'ابحث في الشاشة الرئيسية',
          desc: 'ستظهر أيقونة التطبيق في شاشتك الرئيسية'
        }
      },
      android: {
        title: 'تثبيت على Android',
        step1: {
          title: 'افتح في Chrome',
          desc: 'استخدم Chrome أو متصفح آخر متوافق'
        },
        step2: {
          title: 'قائمة المتصفح',
          desc: 'اضغط على قائمة النقاط الثلاث في Chrome'
        },
        step3: {
          title: 'تثبيت التطبيق',
          desc: 'أكد التثبيت عند المطالبة'
        },
        step4: {
          title: 'تشغيل التطبيق',
      ...
      desktop: {
        title: 'تثبيت على سطح المكتب',
        step1: {
          title: 'متصفح متوافق',
          desc: 'استخدم Chrome أو Edge أو متصفح آخر متوافق مع PWA'
        },
        step2: {
          title: 'مطالبة التثبيت',
          desc: 'اضغط على أيقونة التثبيت أو استخدم قائمة المتصفح'
        },
        step3: {
          title: 'تطبيق سطح المكتب',
          desc: 'سيفتح التطبيق في نافذة منفصلة'
        }
      },
      notifications: {
        newThought: 'تم التقاط فكرة جديدة',
        commitmentCreated: 'تم إنشاء التزام جديد',
        commitmentCompleted: 'تم إكمال الالتزام!',
        reminderTitle: 'لا تنس!',
        dailyReminder: 'حان وقت مراجعة التزاماتك',
      },
    },
  },
};
